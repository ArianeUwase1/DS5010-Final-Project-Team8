...
tracker.add_income(1000, '2022-01-01', 'Salary')
tracker.add_income(500, '2022-02-01', 'Freelance')
tracker.add_expense(200, '2022-01-15', 'Rent')
tracker.add_expense(50, '2022-01-20', 'Groceries')
tracker.add_expense(150, '2022-02-10', 'Dining')
